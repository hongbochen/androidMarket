...
public class DownloadManager {
    ...
    //
    public void addNewDownload(String infoId,String url, String fileName, String target,
                               boolean autoResume, boolean autoRename,
                               final RequestCallBack<File> callback) throws DbException {
        
    	final DownloadInfo downloadInfo = new DownloadInfo();
    	downloadInfo.setId(Long.parseLong(infoId));
    	downloadInfo.setAppID(infoId);
     ...
     * 判断程序是否下载
     */
    public boolean isRunning(AppBriefBean appInfo){
     	boolean running = false;
     	
     	int count = getDownloadInfoListCount();
     	
     	for(int i = 0;i < count;i++){
     		if(appInfo.getAppID().equals(getDownloadInfo(i).getAppID())){
    ...
    public boolean isRunning(String appID){
     	...
     	for(int i = 0;i < count;i++){
     		if(appID.equals(getDownloadInfo(i).getAppID())){
     ...
     *
     */
    public DownloadInfo getById(String appID){
    	DownloadInfo info = null;
    	
    	for(int i = 0 ;i < getDownloadInfoListCount();i++){
    		if(getDownloadInfo(i).getAppID().equals(appID))
    			info = getDownloadInfo(i);
    	}
